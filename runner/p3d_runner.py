...
class P3D_Train(object):
    ...
    def _pre_model(self):
        ...
        if self.resume_epoch == 0:
            print("Training {} from scratch...".format(self.model_info['model_name']))
        else:
            resume_file = PathSet.model_dir(model_name = self.model_info['model_name'], cur_epochs =self.resume_epoch)
...
if __name__ == "__main__":
    ...
    P3D_engine = P3D_Train()
    P3D_engine.model_train()
